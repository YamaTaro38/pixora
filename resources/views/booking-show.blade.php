...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-4xl mx-auto">
        ...
        @php
            ...
            // Check for COD confirmed
            $isCodConfirmed = ($booking->payment_method === 'Bayar di Tempat (COD)' && $booking->booking_status === 'confirmed');
            if ($isCodConfirmed) {
                $statusColor = 'blue';
                $statusIcon = 'fa-store';
                $statusText = 'Konfirmasi COD - Bayar di Studio';
            }
        @endphp
        ...
        <div class="bg-{{ $statusColor }}-50 border-l-4 border-{{ $statusColor }}-500 rounded-lg p-4 mb-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    @if($booking->payment_status == 'pending' && !$isCodConfirmed)
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
            ...
            <div class="p-6">
                ...
                @if($booking->payment_status == 'pending' && $booking->payment_method != 'Bayar di Tempat (COD)')
...
if (paymentStatus === 'success') {
        ...
        html: `
            <div class="text-center">
                <div style="width:80px;height:80px;background:#dcfce7;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
                    <i class="fas fa-check-circle text-green-500" style="font-size:40px;color:#22c55e;"></i>
                </div>
                <h3 style="font-size:20px;font-weight:bold;color:#16a34a;margin-bottom:8px;">Booking Anda Berhasil!</h3>
                <p style="color:#6b7280;">Terima kasih telah booking di Pixora Studio.</p>
                <p style="color:#6b7280;margin-top:8px;">Booking Anda sudah aktif dan terkonfirmasi.</p>
            </div>
        `,
        icon: null,
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-center">
                <div style="width:80px;height:80px;background:#dbeafe;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
                    <i class="fas fa-store" style="font-size:40px;color:#3b82f6;"></i>
                </div>
                <h3 style="font-size:20px;font-weight:bold;color:#2563eb;margin-bottom:8px;">Booking Anda Berhasil!</h3>
                <p style="color:#6b7280;">Terima kasih telah booking di Pixora Studio.</p>
                <p style="color:#6b7280;margin-top:8px;">Silakan lakukan pembayaran saat Anda tiba di studio.</p>
            </div>
        `,
        icon: null,
        confirmButtonColor: '#e11d48',
