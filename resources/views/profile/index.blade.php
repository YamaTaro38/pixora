        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center">
                    <div class="w-24 h-24 bg-rose-100 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden border-2 border-rose-200">
                        @if(Auth::user()->avatar)
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="file" name="avatar" accept="image/*" class="w-full border rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-rose-500 bg-white">
